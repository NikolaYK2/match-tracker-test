...
const ItemSvg = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={ref}>
      <path
        ...
        fill="url(#paint0_linear_68_8389)"
      />
      <path
        ...
        stroke="url(#paint1_linear_68_8389)"
        strokeWidth="2"
      />
      ...
      <path
        ...
        fill="url(#paint3_linear_68_8389)"
      />
      <defs>
...
const ForwardRef = forwardRef(ItemSvg);
